...
4. Chandrayaan-2 TMC-2 / OHRC scenes are not in this table yet. They go through the same `chitra register` command once downloaded (see [DATA](docs/DATA.md)). "Sub-pixel on OHRC↔NAC" is a **target**, not a result.
